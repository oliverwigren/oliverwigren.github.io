...
var soundEffect = new Audio("Ljud/shooting.wav");
soundEffect.play();
this.drawX = startX;
this.drawY = startY;
...
var minX = this.centerX - 50,
    ...
    if (maxX > canvasWidth-65) {
      maxX = canvasWidth-65;
    }
    if (minY < 90) {
      minY = 90;
    }
    if (maxY > canvasHeight-90) {
      maxY = canvasHeight-90;
    }
...
Enemy.prototype.die = function () {
  var soundEffect = new Audio("Ljud/dying.wav");
  soundEffect.play();
...
function checkKey(e, value) {
  ...
  if(keyID === 37 || keyID === 65) { //Left arrow
    player1.isLeftKey = value;
    e.preventDefault();
  }
  if(keyID === 40 || keyID === 83) { //Down arrow
